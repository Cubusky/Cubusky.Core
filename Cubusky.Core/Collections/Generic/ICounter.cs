...
namespace Cubusky.Collections.Generic
{
    ...
    public interface ICounter<TItem> : ICollection<ItemCount<TItem>>, IEnumerable<ItemCount<TItem>>, IEnumerable
    {
        ...
        void ICollection<ItemCount<TItem>>.Add(ItemCount<TItem> itemCount) => Add(itemCount.Item, itemCount.Count);
        bool ICollection<ItemCount<TItem>>.Contains(ItemCount<TItem> itemCount) => Contains(itemCount.Item, itemCount.Count);
        bool ICollection<ItemCount<TItem>>.Remove(ItemCount<TItem> itemCount) => Remove(itemCount.Item, itemCount.Count);
    }
    ...
    public interface IReadOnlyCounter<TItem> : IReadOnlyCollection<ItemCount<TItem>>, IEnumerable<ItemCount<TItem>>, IEnumerable
    {
